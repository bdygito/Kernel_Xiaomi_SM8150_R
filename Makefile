...
HOSTCC       = clang
HOSTCXX      = clang++
HOSTCFLAGS   := -Wall -Wmissing-prototypes -Wstrict-prototypes -O3  -mllvm -polly \
		-fomit-frame-pointer -std=gnu89 $(HOST_LFS_CFLAGS)
HOSTCXXFLAGS := -O3 -mllvm -polly  $(HOST_LFS_CFLAGS)
...
CFLAGS_GCOV	:= -fprofile-arcs -ftest-coverage \
	...
	$(call cc-disable-warning,enum-conversion,)
export CFLAGS_GCOV
